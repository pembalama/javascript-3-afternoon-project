...
let evenNumbers = mixedNumbers.filter((element, index, arr) => {
  return element % 2 === 0;
})
...
//Code Here
let postTaxPrices = prices.map((element, index, arr) => {
  return element * 1.07;
})
...
//Code Here
let totalPopulation = populations.reduce((total, element, index, arr) =>{
...
let bobsTotal = purchases.reduce((total, element, index, arr) => {
